...
with open("zotero.txt","r",encoding='utf-8') as f:
...
#print(data4)
e='\)\) \(\[pdf\]\('
data5 = re.sub(e,'|<div><a href="',data4)
#print(data5)
f='\|<'
data6 = re.sub(f,'">PAPER_LINK</a>|</div><',data5)
#print(data6)
g='\)\) '
data7 = re.sub(g,'">PAGE_LINK</a></div>',data6)
#print(data7)
h='\]\('
...
l='\*\*(.*?)\*\*'
data12 = re.sub(l,r'<b> <font color="#FF0000"> \1 </font> </b>',data11)
